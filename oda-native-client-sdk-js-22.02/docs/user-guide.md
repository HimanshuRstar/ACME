...
| ------ | ------ | ------ | ------ |
| `URI` | No || The Host name in ODA instance URL. Do not include the protocol (`https://`). Only the first path (`/`) needs to be passed here. |
...
| `width` | Suggested percentage of table width that should be provided to the heading | No |
...
| Name | Description | Type | Required? |
| ------ | ------ | ------ | ------ |
| `displayType` | Type of the field | `"text"`, `"link"` | Yes |
| `label` | Key of the field | string | Yes |
| `value` | Value of the field | string | No |
| `linkLabel` | Short label for link value if `displayType` is `"link"` | string | No |
| `alignment` | Positioning of the label within its cell | `"left"`, `"right"`, `"center"` | No |
| `width` | Suggested percentage of table width that should be provided to the field | No |
...
> **Note**: This message type is used for Conversation to SQL (C2SQL), which is a limited availability feature.
